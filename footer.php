...
<?php if (!$pageBlog && !$pagePost || $pageBlog && !$footerHideBlog || $pagePost && !$footerHidePost) { ?>
        <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-ce96">
  <div class="u-clearfix u-sheet u-sheet-1">
    <p class="u-small-text u-text u-text-variant u-text-1">As I said, there isn't much of me, the same goes for my site ~ yet ;)</p>
  </div>
</footer>
