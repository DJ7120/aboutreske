...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'aboutreske_tk_v_2_0'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'aboutreske_tk_v_2_0'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_white_contrast", array(
        'label' => __('Text Dark', 'aboutreske_tk_v_2_0'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_shading_contrast", array(
        'label' => __('Text Light', 'aboutreske_tk_v_2_0'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_background", array(
        'label' => __('Background', 'aboutreske_tk_v_2_0'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_section('fonts', array(
        ...
        'title' => __('Fonts', 'aboutreske_tk_v_2_0'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'aboutreske_tk_v_2_0'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'aboutreske_tk_v_2_0'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_text', array(
        'label' => __('Text Font', 'aboutreske_tk_v_2_0'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_section('typography', array(
        'capability' => 'edit_theme_options',
        'title' => __('Typography', 'aboutreske_tk_v_2_0'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'aboutreske_tk_v_2_0'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'typography_base_size', array(
        'type' => 'number',
        'label' => __('Base Size', 'aboutreske_tk_v_2_0'),
        'section' => 'typography',
        'input_attrs' => array(
            'min'   => 13,
            'max'   => 24,
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'aboutreske_tk_v_2_0'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'aboutreske_tk_v_2_0'),
            '300' => __('300 Light', 'aboutreske_tk_v_2_0'),
            '400' => __('400 Regular', 'aboutreske_tk_v_2_0'),
            '500' => __('500 Medium', 'aboutreske_tk_v_2_0'),
            '700' => __('700 Bold', 'aboutreske_tk_v_2_0'),
            '900' => __('900 Black', 'aboutreske_tk_v_2_0'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'aboutreske_tk_v_2_0'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'aboutreske_tk_v_2_0'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'aboutreske_tk_v_2_0'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'aboutreske_tk_v_2_0'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'aboutreske_tk_v_2_0'),
            'change' => __('Change favicon', 'aboutreske_tk_v_2_0'),
            'remove' => __('Remove', 'aboutreske_tk_v_2_0'),
            'default' => __('Default', 'aboutreske_tk_v_2_0'),
            'placeholder' => __('No favicon selected', 'aboutreske_tk_v_2_0'),
            'frame_title' => __('Select favicon', 'aboutreske_tk_v_2_0'),
            'frame_button' => __('Choose favicon', 'aboutreske_tk_v_2_0'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'aboutreske_tk_v_2_0'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'aboutreske_tk_v_2_0'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_section('excerpt_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Excerpt', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'aboutreske_tk_v_2_0'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'aboutreske_tk_v_2_0'),
        'description' => sprintf(__('ShortTags: %s', 'aboutreske_tk_v_2_0'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_section('seo_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('SEO', 'aboutreske_tk_v_2_0'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'aboutreske_tk_v_2_0'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'aboutreske_tk_v_2_0'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'aboutreske_tk_v_2_0'),
        'left-sidebar' => __('Left', 'aboutreske_tk_v_2_0'),
        'right-sidebar' => __('Right', 'aboutreske_tk_v_2_0'),
        'none' => __('None', 'aboutreske_tk_v_2_0'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'aboutreske_tk_v_2_0'),
        'description' => __('Templates for displaying blogs, archives, search results', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'aboutreske_tk_v_2_0'),
        'description' => __('Templates for displaying single posts', 'aboutreske_tk_v_2_0'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'aboutreske_tk_v_2_0'),
        'description' => __('Templates for displaying single pages and everything else', 'aboutreske_tk_v_2_0'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'aboutreske_tk_v_2_0'));
}
