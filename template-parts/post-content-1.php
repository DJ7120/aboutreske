...
if (!theme_the_post()) return;
 $post2 = $post;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-7f0f">
      ...
      <div class="u-blog-post u-container-style u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--blog_post_header-->
          ...
          <?php if ($post0 !== null) { ?><?php
                            $post_image = theme_get_post_image(array('class' => 'u-blog-control u-image u-image-default u-image-1', 'default' => '/images/1.jpeg'));
          ...
          <?php if ($post0 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-1"><?php _e(sprintf(__('Read more', 'aboutreske_tk_v_2_0'))); ?></a><?php } ?><!--/blog_post_readmore-->
        </div>
      ...
      <div class="u-blog-post u-container-style u-repeater-item u-video-cover u-white">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2"><!--blog_post_header-->
          ...
          <?php if ($post1 !== null) { ?><?php
                            $post_image = theme_get_post_image(array('class' => 'u-blog-control u-image u-image-default u-image-2', 'default' => '/images/2.jpeg'));
                            if ($post_image) echo $post_image; else { echo '<div class="hidden-image"></div>'; $skip_min_height = true; } ?><?php } ?><!--/blog_post_image--><!--blog_post_content-->
          ...
          <?php if ($post1 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-2"><?php _e(sprintf(__('Read more', 'aboutreske_tk_v_2_0'))); ?></a><?php } ?><!--/blog_post_readmore-->
        </div>
      </div><!--/blog_post--><!--blog_post-->
      <div class="u-blog-post u-container-style u-repeater-item u-video-cover u-white">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3"><!--blog_post_header-->
          ...
          <?php if ($post2 !== null) { ?><?php
                            $post_image = theme_get_post_image(array('class' => 'u-blog-control u-image u-image-default u-image-3', 'default' => '/images/3.jpeg'));
                            if ($post_image) echo $post_image; else { echo '<div class="hidden-image"></div>'; $skip_min_height = true; } ?><?php } ?><!--/blog_post_image--><!--blog_post_content-->
          ...
          <?php if ($post2 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-3"><?php _e(sprintf(__('Read more', 'aboutreske_tk_v_2_0'))); ?></a><?php } ?><!--/blog_post_readmore-->
        </div>
      </div><!--/blog_post-->
    </div><!--/blog-->
  </div>
