...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.5.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'aboutreske_tk_v_2_0' ); ?></a>
    <?php if (!$pageBlog && !$pagePost || $pageBlog && !$headerHideBlog || $pagePost && !$headerHidePost) { ?>
    <header class="u-align-right u-clearfix u-header u-header" id="sec-ae6b">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-02cb-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-02cb-20',
                    'submenu_item_class' => 'u-nav-item',
